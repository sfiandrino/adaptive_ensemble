...
if __name__ == "__main__":
    ...
    for h in df_scenarios['horizon'].unique().astype(int)[round_init:end_round]:
        ...
        # write in a json file the dict_keep_trajs
    with open(f"../output_data/persistance_metrics_rmse_wmape/dict_keep_trajs_Ens2_S2_LOP_{loss_function}_{season}.json", "w") as f:
        json.dump(dict_keep_trajs, f)
